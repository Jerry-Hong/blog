...
為了解決這些問題，發展出許多模組機制，像是主流的 CommonJS, AMD 還有ES6 正式的模組化，詳細的JS模組化歷程可以參考我的另一篇文章 **[JavaScript 模組化歷程](/blog/2016-10-19-javascript-module-history/)**，至於 Webpack 在目前主流的模組化機制中都有支援，讀者可先繼續往下看。
